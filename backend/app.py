...
from services.ai_predictor import AI_PERSONALITIES, evaluate_rwa, get_ai_prediction
...
# === AI Predictor Endpoints (Legacy - Crypto Prediction) ===
@app.get("/api/personalities")
async def list_personalities():
    """
    List all available AI personalities (legacy endpoint for backward compat).
    ...
    return {
        ...
        "note": "For new RWA assessment, use /api/agents and /api/evaluate instead",
    }
